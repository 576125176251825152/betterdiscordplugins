        ...
        return class SplitLargeMessages extends Plugin {
            ...
            this.defaults = {
              general: {
                byNewlines: {
                  ...
                  note: "This will stop Sentences from being cut, but might Result in more Messages being sent",
                },
                leaveGaps: {
                  value: false,
                  description: "Leave Gaps if splitting on empty Newline",
                  note: "If splitting on NewLines and the Line is left empty, this will maintain the Gap",
                },
              },
              amounts: {
                splitCounter: {
                ...
                maxMessages: {
                  ...
                  min: 0,
                  max: 20,
                  description: "Maximum Amount of split Messages",
                  note: "(0 for unlimited) Messages beyond this Count will be discarded",
                },
                attachmentLimit: {
                  value: 0,
                  min: 0,
                  max: undefined,
                  description:
                    "Maximum Amount of Chars, before generating .txt",
                  note: "(0 for never) Never generates a .txt FIle",
                },
              },
            };

            this.modulePatches = {
              before: ["ChannelTextAreaContainer", "ChannelTextAreaEditor"],
              after: ["ChannelTextAreaContainer"],
            };
            ...
            return (settingsPanel = BDFDB.PluginUtils.createSettingsPanel(
              this,
              {
                ...
                children: (_) => {
                  ...
                  for (let key of Object.keys(this.defaults.amounts))
                    if (key != "splitCounter")
                      settingsItems.push(
                        BDFDB.ReactUtils.createElement(
                          BDFDB.LibraryComponents.SettingsSaveItem,
              ...
              BDFDB.ContextMenuUtils.createItem(
                BDFDB.LibraryComponents.MenuItems.MenuGroup,
                {
                  children: BDFDB.ContextMenuUtils.createItem(
                    BDFDB.LibraryComponents.MenuItems.MenuCheckboxItem,
                    {
          ...
          processChannelTextAreaContainer(e) {
            ...
            if (!e.returnvalue) {
                ...
                "onSubmit",
                {
                  instead: (e2) => {
                    if (
                      ...
                      let messages = this.formatText(
                        e2.methodArguments[0].value,
                      ).filter((n) => n);
              ...
              if (
                enabled &&
                index > -1 &&
                children[index].props.textValue &&
                  ...
                  children: BDFDB.ReactUtils.createElement("div", {
                    ...
                    children: BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.TooltipContainer,
                      {
                        ...
                        children: BDFDB.ReactUtils.createElement(
                          BDFDB.LibraryComponents.Heading,
                          {
                            tag: "div",
          ...
          processChannelTextAreaEditor(e) {
            if (
              ...
              e.instance.props.uploadPromptCharacterCount = this.settings
                .amounts.attachmentLimit
                ? this.settings.amounts.attachmentLimit
                : 100000;
          }
          ...
          formatText(text) {
            ...
            for (let j = 0; j < messages.length; j++) {
              if (insertCodeBlock) {
                ...
                messages[j].charCodeAt(0) == 10 &&
                this.settings.general.byNewlines &&
                this.settings.general.leaveGaps
              ) {
              ...
              if (codeBlocks && codeBlocks.length % 2 == 1) {
                ...
                messages[j].charCodeAt(messages[j].length - 1) == 10 &&
                this.settings.general.byNewlines &&
                this.settings.general.leaveGaps
              ) {
                messages[j] = messages[j] + "** **";
          ...
          setLabelsByLanguage() {
            switch (BDFDB.LanguageUtils.getLanguage().id) {
              ...
              case "hi": // Hindi
                return {
                  context_enable:
                    "बड़े संदेशों को छोटे संदेशों में विभाजित करें",
              ...
              case "hu": // Hungarian
                return {
                  context_enable:
                    "A nagy üzenetek felosztása kisebb üzenetekre",
