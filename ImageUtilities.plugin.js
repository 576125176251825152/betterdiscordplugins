    ...
    : (([Plugin, BDFDB]) => {
        ...
        const fileTypes = {
          "3gp": {
            ...
            gif: false,
            video: true,
            signs: [[0x66, 0x74, 0x79, 0x70, 0x33, 0x67]],
          },
          avi: {
            copyable: false,
            searchable: false,
          ...
          mp4: {
            ...
            gif: false,
            video: true,
            signs: [[null, null, null, null, 0x66, 0x74, 0x79, 0x70]],
          },
          "mpeg-1": {
            copyable: false,
            searchable: false,
          ...
          png: {
            ...
            gif: false,
            video: false,
            signs: [[0x89, 0x50, 0x4e, 0x47, 0x0d, 0x0a, 0x1a, 0x0a]],
          },
          svg: {
            copyable: false,
            searchable: false,
        ...
        const LazyImageSiblingComponent = class LazyImageSibling
          extends BdApi.React.Component
        {
          render() {
            if (!this.props.loadedImage) {
              ...
              imageThrowaway.addEventListener("load", function () {
                let aRects = BDFDB.DOMUtils.getRects(
                  document.querySelector(BDFDB.dotCN.appmount),
                );
                let resizeX = (aRects.width / this.width) * 0.8,
                  resizeY = (aRects.height / this.height) * 0.65;
                let ratio = resizeX < resizeY ? resizeX : resizeY;
                instance.props.loadedImage = BDFDB.ReactUtils.createElement(
                  BDFDB.LibraryComponents.LazyImage,
                  {
              ...
              imageThrowaway.src = !_this.isValid(this.props.url, "video")
                ? this.props.url
                : _this.getPosterUrl(this.props.url);
            }
            return BDFDB.ReactUtils.createElement("div", {
              ...
              onClick: (event) => {
                ...
                _this.switchImages(
                  this.props.offset,
                  _this.isValid(this.props.url, "video"),
                );
              },
              children: [
                this.props.loadedImage ||
                  BDFDB.ReactUtils.createElement(
                    BDFDB.LibraryComponents.SpinnerComponents.Spinner,
                    {
                      type: BDFDB.LibraryComponents.SpinnerComponents.Types
                        .WANDERING_CUBES,
                    },
                  ),
                BDFDB.ReactUtils.createElement(
                  ...
                  {
                    className:
                      BDFDB.disCNS._imageutilitiesswitchicon +
                      BDFDB.disCN.svgicon,
        ...
        const ImageDetailsComponent = class ImageDetails
          extends BdApi.React.Component
        {
          componentDidMount() {
            BDFDB.DOMUtils.addClass(
              BDFDB.DOMUtils.getParent(
                BDFDB.dotCN.imagemosaiconebyonegridsingle,
                BDFDB.ReactUtils.findDOMNode(this),
              ),
              BDFDB.disCN._imageutilitiesimagedetailsadded,
            );
            let item = BDFDB.ReactUtils.findValue(
              BDFDB.ObjectUtils.get(
                this,
                `${BDFDB.ReactUtils.instanceKey}.return`,
              ),
              "item",
              { up: true },
            );
          ...
          componentDidUpdate() {
            if (
              (!this.props.attachment || !this.props.attachment.size) &&
              !this.props.loaded
            ) {
          ...
          render() {
            return !this.props.attachment
              ...
              : BDFDB.ReactUtils.createElement("span", {
                  ...
                  children: [
                    BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.Anchor,
                      {
                    ...
                    BDFDB.ReactUtils.createElement("span", {
                      children: BDFDB.NumberUtils.formatBytes(
                        this.props.attachment.size,
                      ),
                    }),
                    BDFDB.ReactUtils.createElement("span", {
                      ...
                      BDFDB.LibraryComponents.TooltipContainer,
                      {
                        ...
                        children: BDFDB.ReactUtils.createElement(
                          BDFDB.LibraryComponents.SvgIcon,
                          {
                            ...
                            name: BDFDB.LibraryComponents.SvgIcon.Names
                              .DOWNLOAD,
                            width: 16,
                            height: 16,
                            onClick: (event) => {
                              ...
                              _this.downloadFile({
                                url:
                                  this.props.attachment.proxy_url ||
                                  this.props.original,
                              });
                            },
                            onContextMenu: (event) => {
                              let locations = Object.keys(ownLocations).filter(
                                (n) => ownLocations[n].enabled,
                              );
                              if (locations.length)
                                  ...
                                  BDFDB.ContextMenuUtils.createItem(
                                    BDFDB.LibraryComponents.MenuItems.MenuGroup,
                                    {
                                      children: locations.map((name, i) =>
                                        BDFDB.ContextMenuUtils.createItem(
                                          BDFDB.LibraryComponents.MenuItems
                                            .MenuItem,
                                          {
        ...
        return class ImageUtilities extends Plugin {
          onLoad() {
            ...
            this.defaults = {
              general: {
                nsfwMode: {
                  value: false,
                  description: "Blurs Media that is posted in NSFW Channels",
                },
              },
              viewerSettings: {
                zoomMode: {
                  value: true,
                  description:
                    "Enables Zoom Mode to zoom into Images while holding down your Mouse",
                },
                galleryMode: {
                  value: true,
                  description:
                    "Enables Gallery Mode to quick-switch between Images",
                },
                details: {
                  value: true,
                  description: "Adds Image Details (Name, Size, Amount)",
                },
              },
              galleryFilter: {},
              zoomSettings: {
                pixelMode: {
                  value: false,
                  label: "Uses Pixel Lens instead of a Blur Lens",
                },
                clickMode: {
                  value: false,
                  label:
                    "Click Image to zoom instead of holding the Mouse Button",
                },
                lensSize: {
                  value: 200,
                  digits: 0,
              ...
              rescaleSettings: {
                ...
                rescaleEmbeds: {
                  value: true,
                  description: "Resize Image Embeds",
                },
              },
              detailsSettings: {
                footnote: {
                ...
                tooltipDelay: {
                  value: 0,
                  min: 0,
                  description: "Image Tooltip Delay (in ms)",
                },
              },
              places: {
              ...
              engines: {
                _all: {
                  value: true,
                  name: BDFDB.LanguageUtils.LanguageStrings.ALL,
                  url: null,
                },
                Baidu: {
                  value: true,
                  name: "Baidu",
                  url: "http://image.baidu.com/pcdutu?queryImageUrl=",
                },
                Bing: {
                  value: true,
                  name: "Bing",
            ...
            for (let fileType in fileTypes)
              this.defaults.galleryFilter[fileType] = { value: true };
            ...
            this.modulePatches = {
              ...
              componentDidMount: ["LazyImage"],
              componentDidUpdate: ["LazyImage"],
              componentWillUnmount: ["LazyImage"],
            };
          ...
          onStart() {
            BDFDB.ListenerUtils.add(
              this,
              document.body,
              "click",
              [
                BDFDB.dotCN.imageoriginallink,
                "img",
                BDFDB.dotCN.attachmentcover,
                BDFDB.dotCN.attachmentcovericon,
                "video",
              ]
                .map(
                  (n) => BDFDB.dotCNS.message + BDFDB.dotCNS.imagewrapper + n,
                )
                .join(", "),
              (e) => this.cacheClickedImage(e.target),
            );
            ...
            return (settingsPanel = BDFDB.PluginUtils.createSettingsPanel(
              this,
              {
                ...
                children: (_) => {
                  ...
                  settingsItems.push(
                    BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.CollapseContainer,
                      {
                        title: "General",
                        collapseStates: collapseStates,
                        children: Object.keys(this.defaults.general).map(
                          (key) =>
                            BDFDB.ReactUtils.createElement(
                  ...
                  settingsItems.push(
                    BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.CollapseContainer,
                      {
                        ...
                        collapseStates: collapseStates,
                        children: Object.keys(this.defaults.viewerSettings).map(
                          (key) =>
                            BDFDB.ReactUtils.createElement(
                              BDFDB.LibraryComponents.SettingsSaveItem,
                              {
                                ...
                                label:
                                  this.defaults.viewerSettings[key].description,
                  ...
                  settingsItems.push(
                    BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.CollapseContainer,
                      {
                        ...
                        collapseStates: collapseStates,
                        children: Object.keys(this.defaults.galleryFilter).map(
                          (key) =>
                            BDFDB.ReactUtils.createElement(
                              BDFDB.LibraryComponents.SettingsSaveItem,
                              {
                    ...
                    BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.CollapseContainer,
                      {
                        ...
                        children: [
                          BDFDB.ReactUtils.createElement(
                            BDFDB.LibraryComponents.SettingsPanelList,
                            {
                              ...
                              children: Object.keys(
                                this.defaults.rescaleSettings,
                              )
                                .filter(
                                  (key) =>
                                    typeof this.defaults.rescaleSettings[key]
                                      .value != "boolean",
                                )
                                .map((key) =>
                                  BDFDB.ReactUtils.createElement(
                                    BDFDB.LibraryComponents.SettingsSaveItem,
                                    {
                                      ...
                                      label:
                                        this.defaults.rescaleSettings[key]
                                          .description,
                                      basis: "50%",
                                      options: Object.keys(rescaleOptions).map(
                                        (n) => ({
                                          value: n,
                                          label: rescaleOptions[n],
                                        }),
                                      ),
                          ...
                          Object.keys(this.defaults.rescaleSettings)
                            .filter(
                              (key) =>
                                typeof this.defaults.rescaleSettings[key]
                                  .value == "boolean",
                        ...
                        children: [
                          BDFDB.ReactUtils.createElement(
                            BDFDB.LibraryComponents.SettingsPanelList,
                            {
                              ...
                              children: Object.keys(
                                this.defaults.detailsSettings,
                              )
                                .filter(
                                  (key) =>
                                    typeof this.defaults.detailsSettings[key]
                                      .value == "boolean",
                                )
                                .map((key) =>
                                  BDFDB.ReactUtils.createElement(
                                    BDFDB.LibraryComponents.SettingsSaveItem,
                                    {
                                      ...
                                      label:
                                        this.defaults.detailsSettings[key]
                                          .description,
                          ...
                          Object.keys(this.defaults.detailsSettings)
                            .filter(
                              (key) =>
                                typeof this.defaults.detailsSettings[key]
                                  .value != "boolean",
                  ...
                  settingsItems.push(
                    BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.CollapseContainer,
                      {
                        ...
                        children: [
                          BDFDB.ReactUtils.createElement(
                            BDFDB.LibraryComponents.FormTitle.Title,
                            {
                              ...
                              children: [
                                ...
                                BDFDB.ReactUtils.createElement(
                                  BDFDB.LibraryComponents.Button,
                                  {
                                    ...
                                    onClick: (_) => {
                                      for (let key in locationInputs)
                                        if (
                                          !locationInputs[key] ||
                                          !locationInputs[key].trim()
                                        )
                                          return BDFDB.NotificationUtils.toast(
                                            "Fill out all fields to add a new Location",
                                            { type: "danger" },
                                          );
                                      let name = locationInputs.name.trim();
                                      let location =
                                        locationInputs.location.trim();
                                      if (
                                        ownLocations[name] ||
                                        name == "Downloads"
                                      )
                                        return BDFDB.NotificationUtils.toast(
                                          "A Location with the choosen Name already exists, please choose another Name",
                                          { type: "danger" },
                                        );
                                      else if (
                                        !BDFDB.LibraryRequires.fs.existsSync(
                                          location,
                                        )
                                      )
                                        return BDFDB.NotificationUtils.toast(
                                          "The choosen download Location is not a valid Path to a Folder",
                                          { type: "danger" },
                                        );
                                      else {
                                        ownLocations[name] = {
                                        ...
                                        BDFDB.PluginUtils.refreshSettingsPanel(
                                          this,
                                          settingsPanel,
                                          collapseStates,
                                        );
                                    ...
                                    children:
                                      BDFDB.LanguageUtils.LanguageStrings.ADD,
                                  },
                                ),
                              ],
                            },
                        ...
                        children: [
                          BDFDB.ReactUtils.createElement(
                            BDFDB.LibraryComponents.SettingsPanelList,
                            {
                              ...
                              children: Object.keys(this.defaults.places).map(
                                (key) =>
                                  BDFDB.ReactUtils.createElement(
                                    BDFDB.LibraryComponents.SettingsSaveItem,
                                    {
                                      ...
                                      keys: ["places", key],
                                      label:
                                        this.defaults.places[key].description,
                          ...
                          BDFDB.ReactUtils.createElement(
                            BDFDB.LibraryComponents.SettingsPanelList,
                            {
                              ...
                              children: Object.keys(this.defaults.engines)
                                .filter((key) => key != "_all")
                                .map((key) =>
                                  BDFDB.ReactUtils.createElement(
                                    BDFDB.LibraryComponents.SettingsSaveItem,
          ...
          forceUpdateAll() {
            ...
            ownLocations = Object.assign(
              !loadedLocations || !loadedLocations.Downloads
                ? {
                    Downloads: {
                      enabled: true,
                      location: this.getDownloadLocation(),
                    },
                  }
                : {},
              loadedLocations,
          ...
          onGuildContextMenu(e) {
            if (!this.settings.places.guildIcons || !e.instance.props.guild)
              return;
            if (
              (BDFDB.DOMUtils.getParent(
                BDFDB.dotCNC.guildheader + BDFDB.dotCN.guildchannels,
                e.instance.props.target,
              ) &&
                !e.instance.props.target.className &&
                e.instance.props.target.parentElement.firstElementChild ==
                  e.instance.props.target) ||
              (e.instance.props.target.className &&
                e.instance.props.target.className.indexOf(
                  BDFDB.disCN.guildheaderbanneranimatedhoverlayer,
                ) > -1)
            ) {
              let banner = BDFDB.GuildUtils.getBanner(
                e.instance.props.guild.id,
              );
              if (banner)
                this.injectItem(
                  e,
                  [
                    banner.replace(/\.webp|\.gif/, ".png"),
                    e.instance.props.guild.banner &&
                      BDFDB.LibraryModules.IconUtils.isAnimatedIconHash(
                        e.instance.props.guild.banner,
                      ) &&
                      banner.replace(/\.webp|\.png/, ".gif"),
                  ],
                  {
                    prefix: BDFDB.LanguageUtils.LibraryStrings.guildbanner,
                    id: "banner",
                  },
                );
            } else if (
              !BDFDB.DOMUtils.getParent(
                BDFDB.dotCN.guildchannels,
                e.instance.props.target,
              )
            ) {
              this.injectItem(
                ...
                [
                  (
                    BDFDB.GuildUtils.getIcon(e.instance.props.guild.id, 4096) ||
                    ""
                  ).replace(/\.webp|\.gif/, ".png"),
                  e.instance.props.guild.icon &&
                    BDFDB.LibraryModules.IconUtils.isAnimatedIconHash(
                      e.instance.props.guild.icon,
                    ) &&
                    BDFDB.GuildUtils.getIcon(
                      e.instance.props.guild.id,
                      4096,
                      true,
                    ),
                ...
                {
                  prefix: BDFDB.LanguageUtils.LibraryStrings.guildicon,
                  id: "icon",
                },
              );
            }
          ...
          onUserContextMenu(e) {
            if (this.settings.places.userAvatars && e.instance.props.user) {
              const guildId =
                BDFDB.LibraryStores.SelectedGuildStore.getGuildId();
              const member = BDFDB.LibraryStores.GuildMemberStore.getMember(
                guildId,
                e.instance.props.user.id,
              );
              this.injectItem(e, [
                (e.instance.props.user.getAvatarURL(null, 4096) || "").replace(
                  /\.webp|\.gif/,
                  ".png",
                ),
                BDFDB.LibraryModules.IconUtils.isAnimatedIconHash(
                  e.instance.props.user.avatar,
                ) && e.instance.props.user.getAvatarURL(null, 4096, true),
                (
                  e.instance.props.user.getAvatarURL(guildId, 4096) || ""
                ).replace(/\.webp|\.gif/, ".png"),
                member &&
                  member.avatar &&
                  BDFDB.LibraryModules.IconUtils.isAnimatedIconHash(
                  ...
                  e.instance.props.user.getAvatarURL(guildId, 4096, true),
              ]);
            }
            if (this.settings.places.streamPreviews && e.instance.props.user) {
              let stream =
                BDFDB.LibraryStores.ApplicationStreamingStore.getAnyStreamForUser(
                  e.instance.props.user.id,
                );
              let previewUrl =
                stream &&
                BDFDB.LibraryStores.ApplicationStreamPreviewStore.getPreviewURL(
                  stream.guildId,
                  stream.channelId,
                  stream.ownerId,
                );
              if (previewUrl)
                this.injectItem(e, [previewUrl], {
                  id: "stream",
                  label: this.labels.context_streamactions,
                });
            }
          }
          ...
          onGroupDMContextMenu(e) {
            if (
              !this.settings.places.groupIcons ||
              !e.instance.props.channel ||
              !e.instance.props.channel.isGroupDM()
            )
              return;
            this.injectItem(e, [
              (
                BDFDB.DMUtils.getIcon(e.instance.props.channel.id) || ""
              ).replace(/\.webp|\.gif/, ".png"),
            ]);
          }
          ...
          onMessageContextMenu(e) {
            if (
              ...
              return;
            const target =
              (e.instance.props.target.tagName == "A" &&
                BDFDB.DOMUtils.containsClass(
                  e.instance.props.target,
                  BDFDB.disCN.imageoriginallink,
                ) &&
                e.instance.props.target.parentElement.querySelector("img")) ||
              (
                BDFDB.DOMUtils.getParent(
            ...
            if (
              target.tagName == "A" &&
              e.instance.props.message.embeds &&
              e.instance.props.message.embeds[0] &&
              (e.instance.props.message.embeds[0].type == "image" ||
                e.instance.props.message.embeds[0].type == "video" ||
                e.instance.props.message.embeds[0].type == "gifv")
            )
              this.injectItem(e, [target.href], { isNative: true });
            else if (
              target.tagName == "IMG" &&
              target.complete &&
              ...
              if (
                BDFDB.DOMUtils.getParent(BDFDB.dotCN.imagewrapper, target) ||
                BDFDB.DOMUtils.containsClass(target, BDFDB.disCN.imagesticker)
              )
                this.injectItem(
                  e,
                  [
                    {
                      file: target.src,
                      original:
                        this.getTargetLink(e.instance.props.target) ||
                        this.getTargetLink(target),
                    },
                  ],
                  { isNative: true },
                );
                ...
                BDFDB.DOMUtils.containsClass(
                  target,
                  BDFDB.disCN.embedauthoricon,
                ) &&
                this.settings.places.userAvatars
              )
                this.injectItem(e, [target.src], { isNative: true });
              else if (
                BDFDB.DOMUtils.containsClass(
                  target,
                  BDFDB.disCN.emojiold,
                  "emote",
                  false,
                ) &&
                this.settings.places.emojis
              )
                this.injectItem(
                  e,
                  [
                    {
                      file: target.src,
                      alternativeName: target.getAttribute("data-name"),
                    },
                  ],
                  { isNative: true },
                );
              ...
              if (
                BDFDB.DOMUtils.containsClass(target, BDFDB.disCN.embedvideo) ||
                BDFDB.DOMUtils.getParent(BDFDB.dotCN.attachmentvideo, target)
              )
                this.injectItem(
                  e,
                  [
              ...
              const reaction = BDFDB.DOMUtils.getParent(
                BDFDB.dotCN.messagereaction,
                target,
              );
                ...
                if (emoji)
                  this.injectItem(
                    ...
                    [
                      {
                        file: emoji.src,
                        alternativeName: emoji.getAttribute("data-name"),
                      },
                    ],
                    { isNative: true },
                  );
          ...
          injectItem(e, urls, config = {}) {
            ...
            let [nativeParent, nativeIndex] = BDFDB.ContextMenuUtils.findItem(
              e.returnvalue,
              { id: "copy-native-link", group: true },
            );
            if (nativeIndex > -1) {
            ...
            for (let id of ["open-native-link", "copy-image", "save-image"]) {
              let [removeParent, removeIndex] = BDFDB.ContextMenuUtils.findItem(
                e.returnvalue,
                { id: id, group: true },
              );
            ...
            let [children, index] =
              config.isNative && nativeIndex > -1
                ? [nativeParent, nativeIndex]
                : BDFDB.ContextMenuUtils.findItem(e.returnvalue, {
                    id: "devmode-copy-id",
                    group: true,
                  });
            children.splice(
                    ...
                    BDFDB.LibraryComponents.MenuItems.MenuGroup,
                    {
                      children: BDFDB.ContextMenuUtils.createItem(
                        BDFDB.LibraryComponents.MenuItems.MenuItem,
                        {
                          label:
                            config.label ||
                            (this.isValid(validUrls[0].file, "video")
                              ? this.labels.context_videoactions
                              : this.labels.context_imageactions),
                          id: BDFDB.ContextMenuUtils.createItemId(
                            this.name,
                            config.id,
                            "main-subitem",
          ...
          filterUrls(...urls) {
            let addedUrls = [];
            return urls
              .filter((n) => this.isValid((n && n.file) || n))
              .map((n) => {
                let srcUrl = (n.file || n).replace(/^url\(|\)$|"|'/g, "");
                let originalUrl = (n.original || n.file || n).replace(
                  /^url\(|\)$|"|'/g,
                  "",
                );
                let fileUrl = srcUrl;
                if (
                  ...
                  if (fileUrl.split("/https/").length > 1)
                    fileUrl = "https://" + fileUrl.split("/https/").pop();
                  else if (url.split("/http/").length > 1)
                    fileUrl = "http://" + fileUrl.split("/http/").pop();
                }
                const file =
                  fileUrl &&
                  (
                    BDFDB.LibraryModules.URLParser.parse(fileUrl).pathname || ""
                  ).toLowerCase();
                const fileType = file && (file.split(".").pop() || "");
                return (
                  fileUrl &&
                  fileType &&
                  !addedUrls.includes(srcUrl) &&
                  addedUrls.push(srcUrl) && {
                    file: fileUrl,
                    src: srcUrl,
                    original: originalUrl,
                    isGuildSpecific:
                      /^https:\/\/cdn\.discordapp\.com\/guilds\/\d+\/users\/\d+/.test(
                        srcUrl,
                      ),
                    fileType,
                    alternativeName: escape(
                      (n.alternativeName || "").replace(/:/g, ""),
                    ),
                  }
                );
              })
          ...
          isValid(url, type) {
            ...
            if (
              ...
              const file =
                url &&
                (BDFDB.LibraryModules.URLParser.parse(url).pathname || "")
                  .split("%3A")[0]
                  .toLowerCase();
              return (
                file &&
                ((!type &&
                  (url.indexOf("discord.com/streams/guild:") > -1 ||
                    url.indexOf("discordapp.com/streams/guild:") > -1 ||
                    url.indexOf("discordapp.net/streams/guild:") > -1 ||
                    url.startsWith("https://images-ext-1.discordapp.net/") ||
                    url.startsWith("https://images-ext-2.discordapp.net/") ||
                    Object.keys(fileTypes).some(
                      (t) => file.endsWith(`/${t}`) || file.endsWith(`.${t}`),
                    ))) ||
                  ((type == "copyable" || type == "searchable") &&
                    (url.indexOf("discord.com/streams/guild:") > -1 ||
                      url.indexOf("discordapp.com/streams/guild:") > -1 ||
                      url.indexOf("discordapp.net/streams/guild:") > -1)) ||
                  (type &&
                    Object.keys(fileTypes)
                      .filter((t) => fileTypes[t][type])
                      .some(
                        (t) => file.endsWith(`/${t}`) || file.endsWith(`.${t}`),
                      )))
              );
          ...
          getPosterUrl(url) {
            url = (url || "")
              ...
              .split("?size=")[0];
            return (
              url + (url.indexOf("?") > -1 ? "&format=jpeg" : "?format=jpeg")
            );
          }

          createSubMenus(data) {
            return data.urls.length == 1
              ? this.createUrlMenu(data.instance, data.urls[0], data.target)
              : data.urls.map((urlData, i) =>
                  BDFDB.ContextMenuUtils.createItem(
                    BDFDB.LibraryComponents.MenuItems.MenuItem,
                    {
                      label: [
                        urlData.isGuildSpecific &&
                          BDFDB.LanguageUtils.LanguageStrings.SERVER_PROFILE,
                        data.prefix,
                        urlData.fileType.toUpperCase(),
                      ]
                        .filter((n) => n)
                        .join(" "),
                      id: BDFDB.ContextMenuUtils.createItemId(
          ...
          createUrlMenu(instance, urlData, target) {
            let enabledEngines = BDFDB.ObjectUtils.filter(
              this.settings.engines,
              (n) => n,
            );
            let enginesWithoutAll = BDFDB.ObjectUtils.filter(
              enabledEngines,
              (n) => n != "_all",
              true,
            );
            ...
            let type = isVideo
              ? BDFDB.LanguageUtils.LanguageStrings.VIDEO
              : BDFDB.LanguageUtils.LanguageStrings.IMAGE;
            return BDFDB.ContextMenuUtils.createItem(
              BDFDB.LibraryComponents.MenuItems.MenuGroup,
              {
                children: [
                  urlData.original &&
                    urlData.original.indexOf("data:") != 0 &&
                    BDFDB.ContextMenuUtils.createItem(
                      BDFDB.LibraryComponents.MenuItems.MenuItem,
                      {
                        ...
                        action: (_) => {
                          ...
                          url =
                            url.indexOf("discordapp.com/avatars/") > 0 ||
                            url.indexOf("discordapp.com/icons/") > 0
                              ? `${url}?size=4096`
                              : url;
                          BDFDB.LibraryModules.WindowUtils.copy(url);
                          BDFDB.NotificationUtils.toast(
                            BDFDB.LanguageUtils.LanguageStrings.LINK_COPIED,
                            { type: "success" },
                          );
                        },
                      },
                    ),
                  urlData.file != urlData.original &&
                    BDFDB.ContextMenuUtils.createItem(
                      BDFDB.LibraryComponents.MenuItems.MenuItem,
                      {
                        label:
                          BDFDB.LanguageUtils.LanguageStrings.COPY_MEDIA_LINK,
                        id: BDFDB.ContextMenuUtils.createItemId(
                          this.name,
                          "copy-media-link",
                        ),
                  ...
                  urlData.original &&
                    ...
                    BDFDB.ContextMenuUtils.createItem(
                      BDFDB.LibraryComponents.MenuItems.MenuItem,
                      {
                        ...
                        action: (_) =>
                          BDFDB.DiscordUtils.openLink(urlData.original),
                      },
                    ),
                  !this.isValid(urlData.file, "copyable")
                    ? null
                    : BDFDB.ContextMenuUtils.createItem(
                        BDFDB.LibraryComponents.MenuItems.MenuItem,
                        {
                          label: this.labels.context_copy.replace(
                            "{{var0}}",
                            type,
                          ),
                          id: BDFDB.ContextMenuUtils.createItemId(
                          ...
                          action: (_) =>
                            this.copyFile({
                              ...
                              fallbackUrl: urlData.src,
                            }),
                        },
                      ),
                  !document.querySelector(BDFDB.dotCN.imagemodal) &&
                    BDFDB.ContextMenuUtils.createItem(
                      BDFDB.LibraryComponents.MenuItems.MenuItem,
                      {
                        label: this.labels.context_view.replace(
                          "{{var0}}",
                          type,
                        ),
                        id: BDFDB.ContextMenuUtils.createItemId(
                        ...
                        action: (_) => {
                          const imageThrowaway = document.createElement(
                            isVideo ? "video" : "img",
                          );
                          imageThrowaway.addEventListener(
                            isVideo ? "loadedmetadata" : "load",
                            function () {
                              _this.cacheClickedImage(target);
                              let open = (_) =>
                                BDFDB.LibraryModules.ModalUtils.openModal(
                                  (modalData) => {
                                    return BDFDB.ReactUtils.createElement(
                                      "div",
                                      {
                                        className:
                                          _this.settings.viewerSettings
                                            .details &&
                                          BDFDB.disCN
                                            ._imageutilitiesdetailsadded,
                                        children:
                                          BDFDB.ReactUtils.createElement(
                                            "div",
                                            {
                                              className:
                                                BDFDB.disCNS
                                                  .modalcarouselmodal +
                                                BDFDB.disCNS.imagemodal +
                                                BDFDB.disCNS.modal +
                                                BDFDB.disCN
                                                  ._imageutilitiesviewer,
                                              children:
                                                BDFDB.ReactUtils.createElement(
                                                  BDFDB.LibraryComponents
                                                    .ImageModal,
                              ...
                              if (BDFDB.LibraryComponents.ImageModal != "div")
                                open();
                              else
                                BDFDB.ModuleUtils.lazyLoadModuleImports(
                                  BDFDB.LibraryComponents.ImageModalOuter,
                                ).then((_) => open());
                            },
                          );
                  ...
                  BDFDB.ContextMenuUtils.createItem(
                    BDFDB.LibraryComponents.MenuItems.MenuItem,
                    {
                      label: this.labels.context_saveas.replace(
                        "{{var0}}",
                        type,
                      ),
                      id: BDFDB.ContextMenuUtils.createItemId(
                      ...
                      action: (_) =>
                        this.downloadFile(
                          { url: urlData.original, fallbackUrl: urlData.src },
                          null,
                          urlData.alternativeName,
                        ),
                      children:
                        locations.length &&
                        BDFDB.ContextMenuUtils.createItem(
                  ...
                  !this.isValid(urlData.original, "searchable") ||
                  !engineKeys.length
                    ? null
                    : engineKeys.length == 1
                      ? BDFDB.ContextMenuUtils.createItem(
                          BDFDB.LibraryComponents.MenuItems.MenuItem,
                          {
                            label: this.labels.context_searchwith
                              .replace("{{var0}}", type)
                              .replace(
                                "...",
                                this.defaults.engines[engineKeys[0]].name,
                              ),
                            id: BDFDB.ContextMenuUtils.createItemId(
                              this.name,
                              "single-search",
                            ...
                            action: (event) => {
                              ...
                              BDFDB.DiscordUtils.openLink(
                                this.defaults.engines[engineKeys[0]].url +
                                  encodeURIComponent(urlData.original),
                                {
                      ...
                      : BDFDB.ContextMenuUtils.createItem(
                          BDFDB.LibraryComponents.MenuItems.MenuItem,
                          {
                            label: this.labels.context_searchwith.replace(
                              "{{var0}}",
                              type,
                            ),
                            id: BDFDB.ContextMenuUtils.createItemId(
                            ...
                            children: !engineKeys.length
                              ...
                              : Object.keys(enabledEngines).map((key) =>
                                  BDFDB.ContextMenuUtils.createItem(
                                    BDFDB.LibraryComponents.MenuItems.MenuItem,
                                    {
                                      label: this.defaults.engines[key].name,
                                      ...
                                      action: (event) => {
                                        const open = (url, k) =>
                                          BDFDB.DiscordUtils.openLink(
                                            this.defaults.engines[k].url +
                                              (this.defaults.engines[k].raw
                                                ? url
                                                : encodeURIComponent(url)),
                                            { minimized: event.shiftKey },
                                          );
                                        if (!event.shiftKey)
                                          BDFDB.ContextMenuUtils.close(
                                            instance,
                                          );
                                        if (key == "_all") {
                                          for (let key2 in enginesWithoutAll)
                                            open(urlData.original, key2);
          ...
          processImageModal(e, filterForVideos = false) {
            if (switchedImageProps) {
              ...
              let url = this.getImageSrc(
                (viewedImage && viewedImage.proxy_url) ||
                  e.instance.props.items[0].src ||
                  e.instance.props.items[0].original,
              );
              ...
              if (this.settings.viewerSettings.details) {
                e.returnvalue.props.children.push(
                  BDFDB.ReactUtils.createElement("div", {
                    ...
                    children: [
                      e.instance.props.items[0].alt && {
                        label: "Alt",
                        text: e.instance.props.items[0].alt,
                      },
                      {
                        label: "Source",
                        text: this.removeSizeInUrl(this.removeFormatInUrl(url)),
                      },
                      {
                        label: "Size",
                        text: `${e.instance.props.items[0].width}x${e.instance.props.items[0].height}px`,
                      },
                      cachedImages &&
                        cachedImages.amount &&
                        cachedImages.amount > 1 && {
                          label: filterForVideos ? "Video" : "Image",
                          text: `${cachedImages.index + 1 || 1} of ${cachedImages.amount}`,
                        },
                    ]
                      .filter((n) => n)
                      .map((data) =>
                        BDFDB.ReactUtils.createElement(
                          BDFDB.LibraryComponents.TextElement,
                          {
                            ...
                            children: [
                              BDFDB.ReactUtils.createElement("div", {
                                className:
                                  BDFDB.disCN._imageutilitiesdetailslabel,
                                children: data.label + ":",
                              }),
                              data.text,
                            ],
              ...
              if (this.settings.viewerSettings.galleryMode && viewedImage) {
                if (
                  !cachedImages ||
                  cachedImages.channelId != viewedImage.channelId ||
                  (cachedImages.amount &&
                    this.getImageIndex(cachedImages.all, viewedImage) == -1)
                ) {
                  ...
                  BDFDB.LibraryModules.HTTPUtils.get({
                    ...
                    query: BDFDB.LibraryModules.APIEncodeUtils.stringify({
                      channel_id:
                        channel && channel.guild_id
                          ? (BDFDB.ChannelUtils.isThread(channel) &&
                              channel.parent_id) ||
                            channel.id
                          : null,
                      has: "image",
                    ...
                    .then((result) => {
                      ...
                      if (result) {
                        ...
                        cachedImages = {
                          all: this.filterMessagesForImages(
                            messages,
                            viewedImage,
                            filterForVideos,
                          ),
                        };
                        index = this.getImageIndex(
                          cachedImages.all,
                          viewedImage,
                        );
                      }
                      if (index > -1)
                        cachedImages = Object.assign(cachedImages, {
                          ...
                          newestId: messages[messages.length - 1]
                  ...
                  if (cachedImages.all[cachedImages.index - 1])
                    e.returnvalue.props.children.push(
                      BDFDB.ReactUtils.createElement(
                        LazyImageSiblingComponent,
                        {
                          className: BDFDB.disCN._imageutilitiesprevious,
                          url: this.getImageSrc(
                            cachedImages.all[cachedImages.index - 1]
                              .thumbnail ||
                              cachedImages.all[cachedImages.index - 1],
                          ),
                          offset: -1,
                          svgIcon:
                            BDFDB.LibraryComponents.SvgIcon.Names.LEFT_CARET,
                        },
                      ),
                    );
                  if (cachedImages.all[cachedImages.index + 1])
                    e.returnvalue.props.children.push(
                      BDFDB.ReactUtils.createElement(
                        LazyImageSiblingComponent,
                        {
                          ...
                          offset: 1,
                          svgIcon:
                            BDFDB.LibraryComponents.SvgIcon.Names.RIGHT_CARET,
                        },
                      ),
                    );
                  if (
                    ...
                    this.addListener("keyup", "Gallery", (_) =>
          ...
          processImageModalBar(e) {
            if (viewedImage && viewedImage.url) {
              let item = {};
              for (let key in viewedImage)
                item[
                  key
                    .split("_")
                    .map((n, i) =>
                      i > 0 ? BDFDB.StringUtils.upperCaseFirstChar(n) : n,
                    )
                    .join("")
                ] = viewedImage[key];
              item.alt = undefined;
              item.contentScanMetadata = {
                version: item.contentScanVersion,
                flags: 0,
              };
              ...
              item.sourceMetadata = {
                message: new BDFDB.DiscordObjects.Message(
                  Object.assign({}, item.message, {
                    author: new BDFDB.DiscordObjects.User(item.message.author),
                  }),
                ),
                identifier: {
          ...
          processImageModalButtons(e) {
            ...
            e.returnvalue.props.children = BDFDB.TimeUtils.suppress(
              (...args) => {
                let returnValue = children(...args);
                let [buttons, index] = BDFDB.ReactUtils.findParent(
                  returnValue,
                  {
                    filter: (n) =>
                      n && n.type && n.type.toString().indexOf("ZOOM") > -1,
                  },
                );
                if (index > -1)
                  buttons[index] =
                    this.settings.viewerSettings.zoomMode &&
                    !this.isValid(e.instance.props.item.original, "gif")
                      ? BDFDB.ReactUtils.createElement(
                          BDFDB.LibraryComponents.TooltipContainer,
                          {
                            text: `Zoom ${BDFDB.LanguageUtils.LanguageStrings.SETTINGS}`,
                            tooltipConfig: {
                              type: BDFDB.LibraryComponents.TooltipContainer
                                .Positions.BOTTOM,
                            },
                            children: BDFDB.ReactUtils.createElement(
                              BDFDB.LibraryComponents.Button,
                              {
                                className:
                                  BDFDB.disCNS.imagemodalactionbutton +
                                  BDFDB.disCN.imagemodalactionbuttonwrapper,
                                innerClassName:
                                  BDFDB.disCN.imagemodalactionbuttoninner,
                                look: BDFDB.LibraryComponents.Button.Looks
                                  .BLANK,
                                color:
                                  BDFDB.LibraryComponents.Button.Colors
                                    .TRANSPARENT,
          ...
          processLazyImage(e) {
            if (e.node) {
              if (
                !e.instance.props.src.split("?")[0].endsWith(".gif") &&
                !e.instance.props.src.split("?")[0].endsWith(".mp4") &&
                !e.instance.props.animated &&
                !e.instance.props.children
              )
                for (let ele of [
                  e.node.src && e.node,
                  ...e.node.querySelectorAll("[src]"),
                ].filter((n) => n))
                  ele.src = this.removeFormatInUrl(ele.src);
              if (e.instance.props.resized) {
                let selectors = [
                  "embedgridcontainer",
                  "imagemosaicattachmentscontainer",
                ...
                for (let selector of selectors) {
                  let parent = BDFDB.DOMUtils.getParent(
                    BDFDB.dotCN[selector],
                    e.node,
                  );
                  if (parent)
                    parent.style.setProperty("max-width", "unset", "important");
                  if (parent)
                ...
                for (let ele of [
                  e.node.style.getPropertyValue("width") && e.node,
                  ...e.node.querySelectorAll("[style*='width:'], video"),
                ].filter((n) => n)) {
                  ele.style.setProperty("width", e.instance.props.width + "px");
                  ele.style.setProperty(
                    "max-width",
                    e.instance.props.width + "px",
                  );
                  ele.style.setProperty(
                    "height",
                    e.instance.props.height + "px",
                  );
                  ele.style.setProperty(
                    "max-height",
                    e.instance.props.height + "px",
                ...
                for (let ele of [
                  ...
                  ele.src = this.removeSizeInUrl(ele.src);
                if (
                  e.instance.state.readyState !=
                  BDFDB.DiscordConstants.ImageReadyStates.READY
                ) {
                  e.instance.state.readyState =
                    BDFDB.DiscordConstants.ImageReadyStates.READY;
              ...
              if (
                e.methodname == "componentWillUnmount" &&
                BDFDB.DOMUtils.getParent(
                  BDFDB.dotCNC.imagemodal + BDFDB.dotCN.modalcarouselmodal,
                  e.node,
                )
              ) {
                BDFDB.TimeUtils.clear(viewedImageTimeout);
              ...
              if (
                e.methodname == "componentDidMount" &&
                BDFDB.DOMUtils.getParent(
                  BDFDB.dotCNC.imagemodal + BDFDB.dotCN.modalcarouselmodal,
                  e.node,
                )
                ...
                if (modal) {
                  modal.parentElement.className =
                    BDFDB.DOMUtils.formatClassName(
                      modal.parentElement.className,
                      this.settings.viewerSettings.galleryMode &&
                        BDFDB.disCN._imageutilitiesgallery,
                      this.settings.viewerSettings.details &&
                        BDFDB.disCN._imageutilitiesdetailsadded,
                    );
                  if (this.settings.viewerSettings.galleryMode)
                    BDFDB.DOMUtils.addClass(modal, BDFDB.disCN.imagemodal);
                }

                if (this.isValid(e.instance.props.src, "gif"))
                  e.node.style.setProperty("pointer-events", "none");
                if (
                  this.settings.viewerSettings.zoomMode &&
                  typeof e.instance.props.children != "function" &&
                  !BDFDB.DOMUtils.containsClass(
                  ...
                  let overlay = BDFDB.DOMUtils.create(
                    `<div style="cursor: zoom-in; position: absolute; top: 0; right: 0; bottom: 0; left: 0; pointer-events: all;"></div>`,
                  );
                  e.node.parentElement.parentElement.appendChild(overlay);
                  e.node.parentElement.parentElement.style.setProperty(
                    "position",
                    "relative",
                  );
                  overlay.addEventListener("contextmenu", (event) =>
                    e.node
                      .querySelector("img")
                      .dispatchEvent(new MouseEvent("contextmenu", event)),
                  );
                  overlay.addEventListener(
                    this.settings.zoomSettings.clickMode
                      ? "click"
                      : "mousedown",
                    (event) => {
                      BDFDB.ListenerUtils.stopEvent(event);
                      if (event.which != 1 || e.node.querySelector("video"))
                        return;
                      ...
                      let halfW = lensRects.width / 2,
                        halfH = lensRects.height / 2;
                      let minX = imgRects.left,
                        maxX = minX + imgRects.width;
                      let minY = imgRects.top,
                        maxY = minY + imgRects.height;
                      ...
                      lens.update = (_) => {
                        ...
                        lens.style.setProperty(
                          "width",
                          this.settings.zoomSettings.lensSize + "px",
                          "important",
                        );
                        lens.style.setProperty(
                          "height",
                        ...
                        lens.style.setProperty(
                          "clip-path",
                          `circle(${this.settings.zoomSettings.lensSize / 2 + 2}px at center)`,
                          "important",
                        );
                        lens.firstElementChild.style.setProperty(
                          "clip-path",
                          `circle(${this.settings.zoomSettings.lensSize / 2}px at center)`,
                          "important",
                        );
                        pane.style.setProperty(
                          "left",
                          imgRects.left +
                            (zoomLevel - 1) * (imgRects.left - x - halfW) +
                            "px",
                          "important",
                        );
                        pane.style.setProperty(
                          "top",
                          imgRects.top +
                            (zoomLevel - 1) * (imgRects.top - y - halfH) +
                            "px",
                          "important",
                        );
                        pane.style.setProperty(
                          "width",
                          imgRects.width * zoomLevel + "px",
                          "important",
                        );
                        pane.style.setProperty(
                          "height",
                      ...
                      this.addListener("wheel", "Zoom", (event2) => {
                        if (!document.contains(e.node))
                          this.cleanupListeners("Zoom");
                        else {
                          if (
                            event2.deltaY < 0 &&
                            zoomLevel +
                              this.settings.zoomSettings.zoomSpeed *
                                zoomLevel <=
                              this.defaults.zoomSettings.zoomLevel.maxValue
                          ) {
                            zoomLevel +=
                              this.settings.zoomSettings.zoomSpeed * zoomLevel;
                            lens.update();
                          } else if (
                            event2.deltaY > 0 &&
                            zoomLevel -
                              this.settings.zoomSettings.zoomSpeed *
                                zoomLevel >=
                              this.defaults.zoomSettings.zoomLevel.minValue
                          ) {
                            zoomLevel -=
                              this.settings.zoomSettings.zoomSpeed * zoomLevel;
                            lens.update();
                      ...
                      vanishObserver = new MutationObserver((changes) => {
                        if (!document.contains(e.node)) releasing();
                      });
                      vanishObserver.observe(appMount, {
                        childList: true,
                        subtree: true,
                      });
                    },
              ...
              if (
                this.settings.rescaleSettings.imageViewer != "NONE" &&
                e.instance.props.className &&
                e.instance.props.className.indexOf(
                  BDFDB.disCN.imagemodalimagemedia,
                ) > -1
              ) {
                let aRects = BDFDB.DOMUtils.getRects(
                  document.querySelector(BDFDB.dotCN.appmount),
                ...
                let ratio = Math.min(
                  (aRects.width *
                    (this.settings.viewerSettings.galleryMode ? 0.8 : 1) -
                    20) /
                    e.instance.props.width,
                  (aRects.height -
                    (this.settings.viewerSettings.details ? 280 : 100)) /
                    e.instance.props.height,
                );
                ratio =
                  this.settings.rescaleSettings.imageViewer == "ORIGINAL" &&
                  ratio > 1
                    ? 1
                    : ratio;
                ...
                if (
                  ...
                  e.instance.props.height = height;
                  e.instance.props.maxHeight = height;
                  e.instance.props.src = e.instance.props.src
                    .replace(/width=\d+/, `width=${width}`)
                    .replace(/height=\d+/, `height=${height}`);
                  e.instance.props.resized = true;
                }
              }
              let reactInstance = BDFDB.ObjectUtils.get(
                e,
                `instance.${BDFDB.ReactUtils.instanceKey}`,
              );
              if (
                this.settings.rescaleSettings.messages != "NONE" &&
                [
                  e.instance.props.className,
                  e.instance.props.containerClassName,
                ].every((n) =>
                  [
                    BDFDB.disCN.embedvideoimagecomponent,
                    BDFDB.disCN.embedthumbnail,
                  ].every((m) => (n || "").indexOf(m) == -1),
                ) &&
                BDFDB.ReactUtils.findOwner(reactInstance, {
                  name: "LazyImageZoomable",
                  up: true,
                }) &&
                (e.instance.props.mediaLayoutType != "MOSAIC" ||
                  (
                    BDFDB.ReactUtils.findValue(reactInstance, "message", {
                      up: true,
                    }) || { attachments: [] }
                  ).attachments.filter(
                    (n) => n.content_type && n.content_type.startsWith("image"),
                  ).length < 2)
              ) {
                let aRects = BDFDB.DOMUtils.getRects(
                  document.querySelector(BDFDB.dotCN.appmount),
                );
                let mRects = BDFDB.DOMUtils.getRects(
                  document.querySelector(
                    BDFDB.dotCNC.messageaccessory + BDFDB.dotCN.messagecontents,
                  ),
                );
                let mwRects = BDFDB.DOMUtils.getRects(
                  document.querySelector(BDFDB.dotCN.messagewrapper),
                );
                if (mRects.width || mwRects.width) {
                  let embed = BDFDB.ReactUtils.findValue(
                    reactInstance,
                    "embed",
                    { up: true },
                  );
                  ...
                  let ratio =
                    ((mRects.width || mwRects.width - 120) -
                      (embed && embed.color ? 100 : 0)) /
                    e.instance.props.width;
                  ratio =
                    this.settings.rescaleSettings.messages == "ORIGINAL" &&
                    ratio > 1
                      ? 1
                      : ratio;
                  let width = Math.round(ratio * e.instance.props.width);
          ...
          processLazyImageZoomable(e) {
            if (
              !e.instance.props.item ||
              !e.instance.props.item.originalItem ||
              e.instance.props.src.indexOf(
                "https://media.discordapp.net/attachments",
              ) != 0
            )
              return;
            if (
              this.settings.detailsSettings.tooltip ||
              (this.settings.detailsSettings.footnote &&
                e.instance.props.mediaLayoutType == "MOSAIC" &&
                (
              ...
              const onMouseEnter =
                e.returnvalue.props.onMouseEnter || ((_) => {});
              e.returnvalue.props.onMouseEnter = BDFDB.TimeUtils.suppress(
                (...args) => {
                  BDFDB.TooltipUtils.create(
                    args[0].target,
                    [
                      e.instance.props.item.originalItem.filename,
                      BDFDB.NumberUtils.formatBytes(
                        e.instance.props.item.originalItem.size,
                      ),
            ...
            if (
              ...
              [
                ...
                [BDFDB.disCN.embedmedia, BDFDB.disCN.embedthumbnail].every(
                  (m) => (n || "").indexOf(m) == -1,
                ),
              ) &&
              (e.instance.props.mediaLayoutType != "MOSAIC" ||
          ...
          processMessageAccessories(e) {
            if (
              this.settings.general.nsfwMode &&
              e.instance.props.channel.nsfw
            ) {
              e.instance.props.message = new BDFDB.DiscordObjects.Message(
                e.instance.props.message,
              );
              e.instance.props.message.attachments = [].concat(
                e.instance.props.message.attachments,
              );
              for (let i in e.instance.props.message.attachments)
                if (
                  e.instance.props.message.attachments[i].spoiler != undefined
                ) {
                  e.instance.props.message.attachments[i] = Object.assign(
                    {},
                    e.instance.props.message.attachments[i],
                    {
                      spoiler: true,
                      nsfw: !e.instance.props.message.attachments[i].spoiler,
                    },
                  );
                }
            }
          ...
          processSpoiler(e) {
            if (!e.returnvalue) {
              if (
                this.settings.rescaleSettings.messages != "NONE" &&
                !e.instance.props.inline &&
                e.instance.props.type == "attachment" &&
                e.instance.props.containerStyles
              )
                e.instance.props.containerStyles.maxWidth = "100%";
            } else {
                ...
                e.returnvalue.props.children = BDFDB.TimeUtils.suppress(
                  (...args) => {
                    ...
                    if (item && item.originalItem && item.originalItem.nsfw) {
                      returnedChildren.props.children[0] =
                        BDFDB.ReactUtils.createElement("div", {
          ...
          processUserBanner(e) {
            if (
              !this.settings.places.userAvatars ||
              !e.instance.props.displayProfile ||
              !e.instance.props.displayProfile.banner
            )
              return;
            let div = BDFDB.ReactUtils.findChild(e.returnvalue, {
              type: "div",
            });
            if (div)
              div.props.onContextMenu = (event) => {
                let validUrls = this.filterUrls(
                  BDFDB.UserUtils.getBanner(
                    e.instance.props.user.id,
                    null,
                    false,
                  ),
                  BDFDB.LibraryModules.IconUtils.isAnimatedIconHash(
                    e.instance.props.displayProfile._userProfile.banner,
                  ) &&
                    BDFDB.UserUtils.getBanner(
                      e.instance.props.user.id,
                      null,
                  ...
                  e.instance.props.displayProfile._guildMemberProfile.banner &&
                    BDFDB.UserUtils.getBanner(
                      e.instance.props.user.id,
                      e.instance.props.guildId,
                      false,
                    ),
                  e.instance.props.displayProfile._guildMemberProfile.banner &&
                    BDFDB.LibraryModules.IconUtils.isAnimatedIconHash(
                      e.instance.props.displayProfile._guildMemberProfile
                        .banner,
                    ) &&
                    BDFDB.UserUtils.getBanner(
                      e.instance.props.user.id,
                        ...
                        children:
                          validUrls.length == 1
                            ? this.createSubMenus({
                                ...
                                urls: validUrls,
                                prefix:
                                  BDFDB.LanguageUtils.LanguageStrings
                                    .PROFILE_BANNER,
                              })
                            : BDFDB.ContextMenuUtils.createItem(
                                BDFDB.LibraryComponents.MenuItems.MenuItem,
          ...
          cacheClickedImage(target) {
            ...
            const image =
              (
                BDFDB.DOMUtils.getParent(BDFDB.dotCN.imagewrapper, target) ||
                target
              ).querySelector("img, video") || target;
            if (!image) return;
            const message = BDFDB.ReactUtils.findValue(image, "message", {
              up: true,
            });
            if (!message) return;
            ...
            if (cachedImages)
              cachedImages.index = this.getImageIndex(
                cachedImages.all,
                viewedImage,
              );
            BDFDB.TimeUtils.clear(viewedImageTimeout);
          ...
          requestFile(urls, onLoad, onError, config = {}) {
            if (!urls || typeof onLoad != "function")
              return typeof onError == "function" && onError();
            let url =
              urls.url && urls.url.startsWith("/assets")
                ? window.location.origin + urls.url
                : urls.url || "";
            let isResized =
              !config.orignalSizeChecked &&
              (url.indexOf("width=") > -1 ||
            ...
            BDFDB.LibraryRequires.request(
              ...
              (error, response, buffer) => {
                if (
                  ...
                  if (isResized)
                    this.requestFile(urls, onLoad, onError, {
                      orignalSizeChecked: true,
                    });
                  else if (urls.fallbackUrl && urls.url != urls.fallbackUrl)
                    this.requestFile(
                      { url: urls.fallbackUrl },
                      onLoad,
                      onError,
                    );
          ...
          downloadFile(urls, path, alternativeName) {
            this.requestFile(
              ...
              (url, buffer) => {
                ...
                if (!extension)
                  BDFDB.NotificationUtils.toast(
                    this.labels.toast_save_failed
                      .replace(
                        "{{var0}}",
                        BDFDB.LanguageUtils.LanguageStrings.IMAGE,
                      )
                      .replace("{{var1}}", path || "PC"),
                    { type: "danger" },
                  );
                else {
                  let type = fileTypes[extension].video
                    ? BDFDB.LanguageUtils.LanguageStrings.VIDEO
                    : BDFDB.LanguageUtils.LanguageStrings.IMAGE;
                  if (path)
                    BDFDB.LibraryRequires.fs.writeFile(
                      this.getFileName(
                        path,
                        (
                          alternativeName ||
                      ...
                      (error) => {
                        if (error)
                          ...
                          BDFDB.NotificationUtils.toast(
                            this.labels.toast_save_success
                              .replace("{{var0}}", type)
                              .replace("{{var1}}", path),
                            { type: "success" },
                          );
                    ...
                    let hrefURL = window.URL.createObjectURL(
                      new Blob([buffer], { type: this.getMimeType(extension) }),
                    );
          ...
          copyFile(urls) {
            this.requestFile(
              urls,
              (url) => {
                let type = this.isValid(url, "video")
                  ? BDFDB.LanguageUtils.LanguageStrings.VIDEO
                  : BDFDB.LanguageUtils.LanguageStrings.IMAGE;
                BDFDB.LibraryModules.WindowUtils.copyImage(
                  url.replace(
                    "https://media.discordapp.net",
                    "https://cdn.discordapp.com",
                  ),
                ...
                BDFDB.NotificationUtils.toast(
                  this.labels.toast_copy_success.replace("{{var0}}", type),
                  { type: "success" },
                );
              },
              (_) => {
                BDFDB.NotificationUtils.toast(
                  this.labels.toast_copy_failed.replace(
                    "{{var0}}",
                    BDFDB.LanguageUtils.LanguageStrings.IMAGE,
                  ),
                  { type: "danger" },
          ...
          getDownloadLocation() {
            if (
              downloadsFolder &&
              BDFDB.LibraryRequires.fs.existsSync(downloadsFolder)
            )
              return downloadsFolder;
            let homePath =
              BDFDB.LibraryRequires.process.env.USERPROFILE ||
              BDFDB.LibraryRequires.process.env.HOMEPATH ||
              BDFDB.LibraryRequires.process.env.HOME;
            let downloadPath =
              homePath &&
              BDFDB.LibraryRequires.path.join(homePath, "Downloads");
            if (
              downloadPath &&
              BDFDB.LibraryRequires.fs.existsSync(downloadPath)
            )
              return (downloadsFolder = downloadPath);
            else {
              downloadsFolder = BDFDB.LibraryRequires.path.join(
                BDFDB.BDUtils.getPluginsFolder(),
                "downloads",
              );
              if (!BDFDB.LibraryRequires.fs.existsSync(downloadsFolder))
                BDFDB.LibraryRequires.fs.mkdirSync(downloadsFolder);
              return downloadsFolder;
            }
          }
          ...
          getFileName(path, fileName, extension, i) {
            ...
            let wholePath = BDFDB.LibraryRequires.path.join(
              path,
              i
                ? `${fileName} (${i}).${extension}`
                : `${fileName}.${extension}`,
            );
            if (BDFDB.LibraryRequires.fs.existsSync(wholePath))
              return this.getFileName(path, fileName, extension, i + 1);
          ...
          getFileExtension(intArray) {
            for (let fileType in fileTypes)
              if (
                fileTypes[fileType].signs.some((signs) =>
                  signs.every((hex, i) => hex === null || hex == intArray[i]),
                )
              )
                return fileType;
            return "";
          ...
          getMimeType(fileType) {
            if (fileTypes[fileType])
              return `${fileTypes[fileType].video ? "video" : "image"}/${fileType == "svg" ? "svg+xml" : fileType}`;
            return "";
          }
          ...
          getImageSrc(img) {
            ...
            return typeof img == "string"
              ...
              : img.proxy_url ||
                  img.src ||
                  (typeof img.querySelector == "function" &&
                  img.querySelector("canvas")
                    ? img.querySelector("canvas").src
                    : "");
          }
          ...
          getImageIndex(messages, img) {
            return messages.findIndex(
              (i) =>
                i.message.id == img.message.id &&
                (messages.filter((n) => n.message.id == i.message.id).length <
                  2 ||
                  (i.url &&
                    img.proxy_url &&
                    img.proxy_url.indexOf(i.url) > -1) ||
                  (i.proxy_url &&
                    img.proxy_url &&
                    img.proxy_url.indexOf(i.proxy_url) > -1)),
            );
          }
          ...
          filterMessagesForImages(messages, img, filterForVideos) {
            return messages
              .filter(
                (m) =>
                  m &&
                  m.channel_id == img.channelId &&
                  !BDFDB.LibraryStores.RelationshipStore.isBlocked(
                    m.author.id,
                  ) &&
                  ((firstViewedImage && m.id == firstViewedImage.message.id) ||
                    m.id == img.message.id ||
                    m.embeds.filter((e) => e.image || e.thumbnail || e.video)
                      .length ||
                    m.attachments.filter(
                      (a) => !a.filename.startsWith("SPOILER_"),
                    ).length),
              )
              .map((m) =>
                [m.attachments, m.embeds]
                  .flat(10)
                  .filter((n) => n)
                  .map((i) =>
                    Object.assign(
                      { message: m, channelId: img.channelId },
                      i,
                      i.image,
                      i.thumbnail,
                      i.video,
              ...
              .filter((n) => {
                ...
                if (
                  type &&
                  ((filterForVideos && type != "video") ||
                    (!filterForVideos && type == "video"))
                )
                  return false;
                if (
                  !n.content_type ||
                  img.proxy_url == n.proxy_url ||
                  img.proxy_url == n.url ||
                  img.proxy_url == n.href
                )
                  return true;
                let extension =
                  (n.content_type.split("/")[1] || "").split("+")[0] || "";
                if (
                  extension &&
                  (!fileTypes[extension] ||
                    this.settings.galleryFilter[extension] === false)
                )
                  return false;
                return true;
              });
          ...
          switchImages(offset, filterForVideos) {
            ...
            if (
              offset > 0 &&
              !cachedImages.lastReached &&
              cachedImages.index == cachedImages.amount - 1
            ) {
              let channel = BDFDB.LibraryStores.ChannelStore.getChannel(
                viewedImage.channelId,
              );
              BDFDB.LibraryModules.HTTPUtils.get({
                ...
                if (result && viewedImage) {
                  ...
                  Object.assign(cachedImages, {
                    all: this.filterForCopies(
                      [].concat(
                        cachedImages.all,
                        this.filterMessagesForImages(
                          messages,
                          viewedImage,
                          filterForVideos,
                        ),
            ...
            if (
              offset < 0 &&
              !cachedImages.firstReached &&
              cachedImages.index == 0
            ) {
              let channel = BDFDB.LibraryStores.ChannelStore.getChannel(
                viewedImage.channelId,
              );
              BDFDB.LibraryModules.HTTPUtils.get({
                ...
                query: BDFDB.LibraryModules.APIEncodeUtils.stringify({
                  ...
                  limit: 100,
                  before: (
                    BigInt(cachedImages.oldestId) + BigInt(1)
                  ).toString(),
                }),
              }).then((result) => {
                if (result && viewedImage) {
            ...
            switchedImageProps = {
              ...
              children: !isVideo
                ...
                : (videoData) =>
                    BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.Video,
                      {
                        className:
                          BDFDB.disCNS.embedvideo + BDFDB.disCN.embedmedia,
                        ignoreMaxSize: true,
                        ...
                        play: true,
                        playOnHover:
                          !!BDFDB.LibraryStores.AccessibilityStore
                            .useReducedMotion,
                      },
                    ),
              ...
              sourceMetadata: {
                identifier: {
                  type: isVideo ? "embed" : "attachment",
                  [isVideo ? "embedIndex" : "attachmentId"]: thisViewedImage.id
                    ? thisViewedImage.id
                    : 0,
                },
          ...
          openZoomSettings(event) {
            BDFDB.ContextMenuUtils.open(
              ...
              BDFDB.ContextMenuUtils.createItem(
                BDFDB.LibraryComponents.MenuItems.MenuGroup,
                {
                  children: Object.keys(this.defaults.zoomSettings).map(
                    (type) => {
                      let isBoolean =
                        typeof this.defaults.zoomSettings[type].value ==
                        "boolean";
                      return BDFDB.ContextMenuUtils.createItem(
                        BDFDB.LibraryComponents.MenuItems[
                          isBoolean ? "MenuCheckboxItem" : "MenuSliderItem"
                        ],
                        Object.assign(
                          {
                            id: BDFDB.ContextMenuUtils.createItemId(
                          ...
                          isBoolean
                            ...
                            : {
                                ...
                                renderLabel: (value, instance) =>
                                  BDFDB.ReactUtils.createElement(
                                    BDFDB.LibraryComponents.Flex,
                                    {
                                      align:
                                        BDFDB.LibraryComponents.Flex.Align
                                          .CENTER,
                                      children: [
                                        BDFDB.ReactUtils.createElement(
                                          BDFDB.LibraryComponents.Flex.Child,
                                        ...
                                        BDFDB.ReactUtils.createElement(
                                          ...
                                          {
                                            type: "number",
                                            size: BDFDB.LibraryComponents
                                              .TextInput.Sizes.MINI,
                                            style: { width: 70 },
                                            min: 1,
                                            max: this.defaults.zoomSettings[
                                              type
                                            ].maxValue,
                                            value:
                                              this.settings.zoomSettings[type],
                                            onChange: (value) =>
                                              value &&
                                              value >=
                                                this.defaults.zoomSettings[type]
                                                  .minValue &&
                                              instance.handleValueChange(
                                                BDFDB.NumberUtils.mapRange(
                                                  [
                                                    this.defaults.zoomSettings[
                                                      type
                                                    ].minValue,
                                                    this.defaults.zoomSettings[
                                                      type
                                ...
                                onValueRender: (value) =>
                                  `${value}${this.defaults.zoomSettings[type].unit}`,
                                onValueChange: (value) => {
                                  this.settings.zoomSettings[type] = value;
                                  BDFDB.DataUtils.save(
                                    this.settings.zoomSettings,
          ...
          updateImageModal(switched) {
            ...
            updateTimeout = BDFDB.TimeUtils.timeout(
              (_) => {
                let ownerInstance = BDFDB.ReactUtils.findOwner(
                  document.querySelector(BDFDB.dotCN.imagemodal),
                  {
                    up: true,
                    filter: (n) =>
                      ...
                      n.stateNode &&
                      n.stateNode.props &&
                      n.stateNode.props.isTopModal &&
                      n.stateNode.props.modalKey,
                  },
                );
          ...
          filterForCopies(messages) {
            ...
            for (let message of messages)
              if (
                !filtered.find(
                  (n) =>
                    n.message.id == message.message.id && n.id == message.id,
                )
              )
          ...
          addListener(eventType, type, callback) {
            ...
            if (!eventTypes[type].includes(eventType))
              eventTypes[type].push(eventType);
            document.removeEventListener(
              eventType,
              document[`${eventType}${this.name}${type}Listener`],
            );
            ...
            switch (BDFDB.LanguageUtils.getLanguage().id) {
              case "bg": // Bulgarian
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} не можа да бъде копиран в клипборда",
                  toast_copy_success: "{{var0}} беше копиран в клипборда",
                  toast_save_failed:
                    "{{var0}} не можа да бъде запазен в '{{var1}}'",
              ...
              case "cs": // Czech
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} nemohl být zkopírován do schránky",
              ...
              case "da": // Danish
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} kunne ikke kopieres til udklipsholderen",
                  toast_copy_success:
                    "{{var0}} blev kopieret til udklipsholderen",
              ...
              case "de": // German
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} konnte nicht in die Zwischenablage kopiert werden",
                  toast_copy_success:
                    "{{var0}} wurde in die Zwischenablage kopiert",
                  toast_save_failed:
                    "{{var0}} konnte nicht in '{{var1}}' gespeichert werden",
                  toast_save_success:
                    "{{var0}} wurde in '{{var1}}' gespeichert",
                };
              case "el": // Greek
                return {
                  ...
                  toast_copy_failed:
                    "Δεν ήταν δυνατή η αντιγραφή του {{var0}} στο πρόχειρο",
                  toast_copy_success: "Το {{var0}} αντιγράφηκε στο πρόχειρο",
                  toast_save_failed:
                    "Δεν ήταν δυνατή η αποθήκευση του {{var0}} στο '{{var1}}'",
              ...
              case "es": // Spanish
                return {
                  ...
                  context_streamactions:
                    "Acciones de vista previa de transmisión",
                  ...
                  toast_copy_failed:
                    "{{var0}} no se pudo copiar al portapapeles",
                  toast_copy_success: "{{var0}} se copió en el portapapeles",
                  toast_save_failed:
                    "{{var0}} no se pudo guardar en '{{var1}}'",
              ...
              case "fi": // Finnish
                return {
                  ...
                  toast_save_failed:
                    "Kohdetta {{var0}} ei voitu tallentaa kansioon '{{var1}}'",
                  toast_save_success:
                    "{{var0}} tallennettiin kansioon '{{var1}}'",
                };
              case "fr": // French
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} n'a pas pu être copié dans le presse-papiers",
                  toast_copy_success:
                    "{{var0}} a été copié dans le presse-papiers",
                  toast_save_failed:
                    "{{var0}} n'a pas pu être enregistré dans '{{var1}}'",
                  toast_save_success:
                    "{{var0}} a été enregistré dans '{{var1}}'",
                };
              case "hi": // Hindi
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} को क्लिपबोर्ड पर कॉपी नहीं किया जा सका",
                  toast_copy_success:
                    "{{var0}} को क्लिपबोर्ड पर कॉपी किया गया था",
                  toast_save_failed:
                    "{{var0}} '{{var1}}' में सहेजा नहीं जा सका",
              ...
              case "hr": // Croatian
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} nije moguće kopirati u međuspremnik",
                  toast_copy_success: "{{var0}} je kopirano u međuspremnik",
                  toast_save_failed:
                    "{{var0}} nije moguće spremiti u '{{var1}}'",
              ...
              case "hu": // Hungarian
                return {
                  ...
                  context_searchwith:
                    "Keresés a következőben: {{var0}} a következővel:",
                  ...
                  toast_copy_failed:
                    "A {{var0}} fájl nem másolható a vágólapra",
                  toast_copy_success: "A {{var0}} elemet a vágólapra másolta",
                  toast_save_failed:
                    "A {{var0}} fájl mentése nem sikerült a '{{var1}}' mappába",
              ...
              case "it": // Italian
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} non può essere copiato negli appunti",
                  toast_copy_success: "{{var0}} è stato copiato negli appunti",
                  toast_save_failed:
                    "Impossibile salvare {{var0}} in '{{var1}}'",
              ...
              case "ja": // Japanese
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} をクリップボードにコピーできませんでした",
                  toast_copy_success:
                    "{{var0}} がクリップボードにコピーされました",
                  toast_save_failed:
                    "{{var0}} を「'{{var1}}'」に保存できませんでした",
                  toast_save_success:
                    "{{var0}} は「'{{var1}}'」に保存されました",
                };
              case "ko": // Korean
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} 을 클립 보드에 복사 할 수 없습니다.",
                  toast_copy_success: "{{var0}} 이 클립 보드에 복사되었습니다.",
                  toast_save_failed:
                    "{{var0}} 을 '{{var1}}'에 저장할 수 없습니다.",
                  toast_save_success:
                    "{{var0}} 이 '{{var1}}'에 저장되었습니다.",
                };
              case "lt": // Lithuanian
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} nepavyko nukopijuoti į mainų sritį",
                  toast_copy_success: "{{var0}} buvo nukopijuota į mainų sritį",
                  toast_save_failed:
                    "Nepavyko išsaugoti {{var0}} aplanke '{{var1}}'",
              ...
              case "nl": // Dutch
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} kan niet naar het klembord worden gekopieerd",
                  toast_copy_success:
                    "{{var0}} is naar het klembord gekopieerd",
                  toast_save_failed:
                    "{{var0}} kan niet worden opgeslagen in '{{var1}}'",
              ...
              case "no": // Norwegian
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} kunne ikke kopieres til utklippstavlen",
              ...
              case "pt-BR": // Portuguese (Brazil)
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} não pôde ser copiado para a área de transferência",
                  toast_copy_success:
                    "{{var0}} foi copiado para a área de transferência",
                  toast_save_failed:
                    "{{var0}} não pôde ser salvo em '{{var1}}'",
              ...
              case "ro": // Romanian
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} nu a putut fi copiat în clipboard",
                  toast_copy_success: "{{var0}} a fost copiat în clipboard",
                  toast_save_failed:
                    "{{var0}} nu a putut fi salvat în '{{var1}}'",
              ...
              case "ru": // Russian
                return {
                  ...
                  context_streamactions:
                    "Действия предварительного просмотра трансляции",
                  ...
                  toast_copy_failed:
                    "{{var0}} не удалось скопировать в буфер обмена",
                  toast_copy_success: "{{var0}} скопирован в буфер обмена",
                  toast_save_failed:
                    "{{var0}} не удалось сохранить в '{{var1}}'",
              ...
              case "sv": // Swedish
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} kunde inte kopieras till Urklipp",
              ...
              case "tr": // Turkish
                return {
                  ...
                  toast_save_failed:
                    "{{var0}}, '{{var1}}' konumuna kaydedilemedi",
                  toast_save_success:
                    "{{var0}}, '{{var1}}' konumuna kaydedildi",
                };
              case "uk": // Ukrainian
                return {
                  ...
                  toast_copy_failed:
                    "Не вдалося скопіювати {{var0}} у буфер обміну",
                  toast_copy_success: "{{var0}} скопійовано в буфер обміну",
                  toast_save_failed:
                    "Не вдалося зберегти {{var0}} у '{{var1}}'",
              ...
              case "vi": // Vietnamese
                return {
                  ...
                  toast_copy_failed:
                    "Không thể sao chép {{var0}} vào khay nhớ tạm",
                  toast_copy_success:
                    "{{var0}} đã được sao chép vào khay nhớ tạm",
              ...
              default: // English
                return {
                  ...
                  toast_copy_failed:
                    "{{var0}} could not be copied to the Clipboard",
                  toast_copy_success: "{{var0}} was copied to the Clipboard",
                  toast_save_failed:
                    "{{var0}} could not be saved in '{{var1}}'",
