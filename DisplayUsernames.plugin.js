...
const config = {
  info: {
    ...
    version: "1.4.2",
    description:
      "Displays Discord handle next to display names in chat and adds '`@`' symbol in profile cards.",
    github:
      "https://github.com/HudsonGTV/BetterDiscordPlugins/blob/main/DisplayUsernames/DisplayUsernames.plugin.js",
    github_raw:
      "https://raw.githubusercontent.com/HudsonGTV/BetterDiscordPlugins/main/DisplayUsernames/DisplayUsernames.plugin.js",
  },
  changelog: [
    {
      title: "Fixes",
...
module.exports = !global.ZeresPluginLibrary
  ...
  : (([Plugin, Library]) => {
      const { DiscordModules, WebpackModules, Patcher, PluginUtilities } =
        Library;
          ...
          Patcher.after(module, key, (_, args, ret) => {
            ...
            if (discrim != "0000")
              ret.props.children.push(
                React.createElement(
                  "span",
                  { class: "hg-username-handle" },
                  this.settings.handlesymbol +
                    author.username +
                    (discrim != "0" ? "#" + discrim : ""),
                ),
              );
