...
module.exports = ((_) => {
  ...
  return !window.BDFDB_Global ||
    ...
    : (([Plugin, BDFDB]) => {
        ...
        const GuildDetailsComponent = class GuildDetails
          extends BdApi.React.Component
        {
          ...
          componentDidUpdate() {
            let tooltip = BDFDB.DOMUtils.getParent(
              BDFDB.dotCN.tooltip,
            ...
            if (tooltip)
              BDFDB.DOMUtils.addClass(
                tooltip,
                BDFDB.disCN._serverdetailstooltip,
              );
            else if (
              ...
              BDFDB.DOMUtils.removeClass(
                this.props.tooltipContainer.tooltip.firstElementChild,
                BDFDB.disCN._serverdetailstooltip,
              );
            if (
              this.state.shouldReposition ||
              (_this.settings.amounts.tooltipDelay &&
                this.state.delayed &&
                !this.state.repositioned)
            ) {
          ...
          componentDidMount() {
            if (
              !_this.settings.amounts.tooltipDelay &&
              (!_this.settings.general.onlyShowOnShift ||
                (_this.settings.general.onlyShowOnShift && this.props.shiftKey))
            )
              BDFDB.DOMUtils.addClass(
          ...
          render() {
            ...
            let owner = BDFDB.LibraryStores.UserStore.getUser(
              this.props.guild.ownerId,
            );
            if (!owner && !this.state.fetchedOwner) {
              this.state.fetchedOwner = true;
              BDFDB.LibraryModules.UserProfileUtils.getUser(
                this.props.guild.ownerId,
              ).then((_) => BDFDB.ReactUtils.forceUpdate(this));
            }
            if (
              _this.settings.amounts.tooltipDelay &&
              !this.state.delayed &&
              ...
              let src = BDFDB.GuildUtils.getIcon(
                this.props.guild.id,
                4096,
              ...
              let roles = BDFDB.LibraryStores.GuildRoleStore.getSortedRoles(
                this.props.guild.id,
              );
              return BDFDB.ReactUtils.createElement(
                BDFDB.LibraryComponents.Flex,
                {
                  ...
                  children: [
                    ...
                    _this.settings.items.owner &&
                      BDFDB.ReactUtils.createElement(GuildDetailsRowComponent, {
                        prefix:
                          BDFDB.LanguageUtils.LanguageStrings.SERVER_OWNER,
                        string: !owner
                          ? BDFDB.LanguageUtils.LanguageStrings.UNKNOWN_USER
                          : owner.username,
                      }),
                    _this.settings.items.creationDate &&
                      BDFDB.ReactUtils.createElement(GuildDetailsRowComponent, {
                        prefix: _this.labels.creation_date,
                        string: BDFDB.LibraryComponents.DateInput.format(
                          _this.settings.dates.tooltipDates,
                          BDFDB.LibraryModules.TimestampUtils.extractTimestamp(
                            this.props.guild.id,
                          ),
                        ),
                      }),
                    _this.settings.items.joinDate &&
                      BDFDB.ReactUtils.createElement(GuildDetailsRowComponent, {
                        prefix: _this.labels.join_date,
                        string: BDFDB.LibraryComponents.DateInput.format(
                          _this.settings.dates.tooltipDates,
                          this.props.guild.joinedAt,
                        ),
                      }),
                    _this.settings.items.members &&
                      BDFDB.ReactUtils.createElement(GuildDetailsRowComponent, {
                        prefix: BDFDB.LanguageUtils.LanguageStrings.MEMBERS,
                        string:
                          BDFDB.LibraryStores.GuildMemberCountStore.getMemberCount(
                            this.props.guild.id,
                          ),
                      }),
                    _this.settings.items.boosts &&
                      BDFDB.ReactUtils.createElement(GuildDetailsRowComponent, {
                        prefix: _this.labels.boosts,
                        string: this.props.guild.premiumSubscriberCount,
                      }),
                    _this.settings.items.channels &&
                      BDFDB.ReactUtils.createElement(GuildDetailsRowComponent, {
                        prefix: BDFDB.LanguageUtils.LanguageStrings.CHANNELS,
                        string:
                          BDFDB.LibraryStores.GuildChannelStore.getChannels(
                            this.props.guild.id,
                          ).count,
                      }),
                    _this.settings.items.roles &&
                      roles &&
                      roles.length &&
                      BDFDB.ReactUtils.createElement(GuildDetailsRowComponent, {
                        prefix: BDFDB.LanguageUtils.LanguageStrings.ROLES,
                        string: roles.filter((n) => n.id != this.props.guild.id)
                          .length,
                      }),
                    _this.settings.items.language &&
                      BDFDB.ReactUtils.createElement(GuildDetailsRowComponent, {
                        prefix: BDFDB.LanguageUtils.LanguageStrings.LANGUAGE,
                        string:
                          BDFDB.LanguageUtils.getName(
                            BDFDB.LanguageUtils.languages[
                              this.props.guild.preferredLocale
                            ],
                          ) || this.props.guild.preferredLocale,
                      }),
                  ]
        ...
        const GuildDetailsRowComponent = class GuildDetailsRow
          extends BdApi.React.Component
        {
          render() {
            return this.props.prefix.length + this.props.string.length >
              Math.round(34 * (_this.settings.amounts.tooltipWidth / 300))
              ? [
                  BDFDB.ReactUtils.createElement("div", {
        ...
        return class ServerDetails extends Plugin {
            ...
            this.defaults = {
              general: {
                onlyShowOnShift: {
                  value: false,
                  description:
                    "Only show the Details Tooltip, while holding 'Shift'",
                },
              },
              items: {
                  ...
                  settingsItems.push(
                    BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.CollapseContainer,
                      {
                        title: "Tooltip Items",
                        collapseStates: collapseStates,
                        children: Object.keys(this.defaults.items).map((key) =>
                          BDFDB.ReactUtils.createElement(
                            BDFDB.LibraryComponents.SettingsSaveItem,
                            {
                              type: "Switch",
                              ...
                              label:
                                this.labels[
                                  this.defaults.items[key].description
                                ] ||
                  ...
                  settingsItems.push(
                    BDFDB.ReactUtils.createElement(
                      BDFDB.LibraryComponents.CollapseContainer,
                      {
                        ...
                        collapseStates: collapseStates,
                        children: Object.keys(this.defaults.dates)
                          .map((key) =>
                            BDFDB.ReactUtils.createElement(
                              BDFDB.LibraryComponents.DateInput,
                              Object.assign({}, this.settings.dates[key], {
                          ...
                          .concat(
                            BDFDB.ReactUtils.createElement(
                              BDFDB.LibraryComponents.FormDivider,
                              {
                          ...
                          .concat(
                            Object.keys(this.defaults.amounts).map((key) =>
                              BDFDB.ReactUtils.createElement(
                                BDFDB.LibraryComponents.SettingsSaveItem,
                                {
                                  type: "Slider",
                                  ...
                                  markerAmount: 11,
                                  onValueRender: (value) =>
                                    value + this.defaults.amounts[key].unit,
                          ...
                          .concat(
                            Object.keys(this.defaults.colors).map((key) =>
                              BDFDB.ReactUtils.createElement(
                                BDFDB.LibraryComponents.SettingsSaveItem,
                                {
                                  type: "TextInput",
          ...
          processGuildItem(e) {
            if (
              !e.instance.props.guild ||
              typeof e.instance.props?.children?.props?.className != "string" ||
              e.instance.props?.children?.props?.className.indexOf(
                BDFDB.disCN.guildcontainer,
              ) == -1
            )
              return;
            ...
            e.returnvalue = BDFDB.ReactUtils.createElement(
              ...
              Object.assign({}, e.returnvalue.props, {
                ref: (instance) => {
                  if (instance) tooltipContainer = instance;
                },
                ...
                text: (instance, event) =>
                  BDFDB.ReactUtils.createElement(GuildDetailsComponent, {
