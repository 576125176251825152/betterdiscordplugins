...
module.exports = ((_) => {
  ...
  return !window.BDFDB_Global ||
    ...
    : (([Plugin, BDFDB]) => {
        ...
        const ActivityToggleComponent = class ActivityToggle
          extends BdApi.React.Component
        {
          ...
          render() {
            const enabled =
              this.props.forceState != undefined
                ? this.props.forceState
                : BDFDB.DiscordUtils.getSetting("status", "showCurrentGame");
            ...
            return BDFDB.ReactUtils.createElement(
              "div",
              {
                ...
                children: BDFDB.ReactUtils.createElement(
                  BDFDB.LibraryComponents.PanelButton,
                  Object.assign({}, this.props, {
                    redGlow: !enabled,
                    tooltipText: enabled
                      ? _this.labels.disable_activity
                      : _this.labels.enable_activity,
                    icon: (iconProps) =>
                      BDFDB.ReactUtils.createElement("div", {
                        className: BDFDB.disCN.lottieicon,
                        style: {
                          "--__lottieIconColor": enabled
                            ? "currentColor"
                        ...
                        children: BDFDB.ReactUtils.createElement(
                          ...
                          Object.assign({}, iconProps, {
                            ...
                            name: enabled
                              ? BDFDB.LibraryComponents.SvgIcon.Names.GAMEPAD
        ...
        const ActivityToggleItemComponent = class ActivityToggleItem
          extends BdApi.React.Component
        {
          componentDidMount() {
            toggleItem = this;
        ...
        return class GameActivityToggle extends Plugin {
          onLoad() {
            ...
            this.defaults = {
              general: {
                showButton: {
                  value: true,
                  description: "Show Quick Toggle Button",
                },
                showItem: {
                  value: false,
                  description: "Show Quick Toggle Item",
                },
          ...
          onStart() {
            sounds = [
              BDFDB.LibraryModules.SoundParser &&
                BDFDB.LibraryModules.SoundParser.keys(),
            ]
              .flat(10)
              .filter((n) => n)
            ...
            let state = BDFDB.DiscordUtils.getSetting(
              "status",
              "showCurrentGame",
            );
            if (
              !cachedState.date ||
              new Date() - cachedState.date > 1000 * 60 * 60 * 24 * 3
            ) {
              cachedState.value = state;
              cachedState.date = new Date();
              BDFDB.DataUtils.save(cachedState, this, "cachedState");
            } else if (cachedState.value != null && cachedState.value != state)
              BDFDB.DiscordUtils.setSetting(
                "status",
                "showCurrentGame",
                cachedState.value,
              );
              ...
              BDFDB.PatchUtils.patch(this, SettingsStore, "updateAsync", {
                after: (e) => {
                  ...
                  if (newSettings.showCurrentGame != undefined) {
                    if (toggleButton)
                      toggleButton.props.forceState =
                        newSettings.showCurrentGame.value;
                    BDFDB.ReactUtils.forceUpdate(toggleButton);
                    if (toggleItem)
                      toggleItem.props.forceState =
                        newSettings.showCurrentGame.value;
                    BDFDB.ReactUtils.forceUpdate(toggleItem);
                    BDFDB.DataUtils.save(
                      {
                        date: new Date(),
                        value: newSettings.showCurrentGame.value,
                      },
                      this,
                      "cachedState",
                    );
            ...
            return (settingsPanel = BDFDB.PluginUtils.createSettingsPanel(
              this,
              {
                ...
                children: (_) => {
                  ...
                  for (let key in this.defaults.selections)
                    settingsItems.push(
                      BDFDB.ReactUtils.createElement(
                        BDFDB.LibraryComponents.SettingsSaveItem,
                        {
                          ...
                          basis: "50%",
                          options: sounds.map((o) => ({
                            value: o,
                            label: o
                              .split(/[-_]/g)
                              .map(BDFDB.StringUtils.upperCaseFirstChar)
                              .join(" "),
                          })),
                          value: this.settings.selections[key],
                          onChange: (value) =>
                            BDFDB.LibraryModules.SoundUtils.playSound(
                              value,
                              0.4,
                            ),
                        },
                      ...
                      children: BDFDB.ReactUtils.createElement("div", {
                        ...
                        children: [
                          ...
                          BDFDB.ReactUtils.createElement(
                            ...
                            {
                              className:
                                BDFDB.disCNS.settingsrowcontrol +
                                BDFDB.disCN.flexchild,
                              grow: 0,
                              wrap: true,
                              children: BDFDB.ReactUtils.createElement(
                                BDFDB.LibraryComponents.KeybindRecorder,
                                {
          ...
          processAccount(e) {
            ...
            let insertButton = (returnvalue) => {
              let accountinfo = BDFDB.ReactUtils.findChild(returnvalue, {
                props: [["className", BDFDB.disCN.accountinfo]],
              });
              if (!accountinfo) return;
              let buttons = BDFDB.ReactUtils.findChild(returnvalue, {
                props: [["className", BDFDB.disCN.accountinfobuttons]],
              });
              if (buttons) {
                accountinfo.props.className = BDFDB.DOMUtils.formatClassName(
                  accountinfo.props.className,
                  BDFDB.disCN._gameactivitytoggleadded,
                );
                buttons.props.children.unshift(
                  BDFDB.ReactUtils.createElement(ActivityToggleComponent, {}),
                );
              } else {
            ...
            if (
              ...
              e.returnvalue.props.children[0].props &&
              typeof e.returnvalue.props.children[0].props.children ==
                "function"
            ) {
              let childrenRender =
                e.returnvalue.props.children[0].props.children;
              e.returnvalue.props.children[0].props.children =
                BDFDB.TimeUtils.suppress(
                  ...
                  "Error in Children Render in Account!",
                  this,
                );
          ...
          processAccountPopout(e) {
            ...
            let userpopoutMenus = BDFDB.ReactUtils.findChild(e.returnvalue, {
              props: [["className", BDFDB.disCN.userpopoutmenus]],
            });
            if (!userpopoutMenus) return;
            userpopoutMenus.props.children.splice(
              1,
              0,
              BDFDB.ReactUtils.createElement("div", {
                className:
                  BDFDB.disCNS.userpopoutoverlay +
                  BDFDB.disCN.userpopoutmenuoverlay,
                children: BDFDB.ReactUtils.createElement("ul", {
                  children: BDFDB.ReactUtils.createElement(
                    ActivityToggleItemComponent,
                    {},
                  ),
                }),
              }),
          ...
          activateKeybind() {
            if (keybind && keybind.length)
              BDFDB.ListenerUtils.addGlobal(
                this,
                "GAMEACTIVITY_TOGGLE",
                keybind,
                (_) => this.toggle(),
          ...
          toggle() {
            const shouldEnable = !BDFDB.DiscordUtils.getSetting(
              "status",
              "showCurrentGame",
            );
            this.settings.general[
              shouldEnable ? "playEnable" : "playDisable"
            ] &&
              BDFDB.LibraryModules.SoundUtils.playSound(
                this.settings.selections[
                  shouldEnable ? "enableSound" : "disableSound"
                ],
                0.4,
              );
            BDFDB.DiscordUtils.setSetting(
