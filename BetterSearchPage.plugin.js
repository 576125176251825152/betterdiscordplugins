    ...
    : (([Plugin, BDFDB]) => {
        return class BetterSearchPage extends Plugin {
          ...
          processSearchResults(e) {
            ...
            if (index == -1) return;
            let onPageChange = BDFDB.ReactUtils.findValue(
              e.returnvalue,
              "onPageChange",
            );
            if (onPageChange)
              children.splice(
                ...
                BDFDB.ReactUtils.createElement(
                  BDFDB.LibraryComponents.SearchResultsPagination,
                  {
                    onPageChange: (newPage) =>
                      !e.instance.props.search.searching &&
                      onPageChange(newPage),
                    offset: e.instance.props.search.offset,
                    totalCount:
                      e.instance.props.search.totalResults > 9976
                        ? 9976
