...
const manifest = {
  ...
  donate: "https://paypal.me/domibtnr",
  source:
    "https://github.com/domi-btnr/BetterDiscordStuff/tree/development/ShowSpectators",
  changelog: [
    {
      title: "It works again!",
      type: "fixed",
      items: ["The Panel shows up again", "Localisation works again"],
    },
  ],
  changelogDate: "2026-01-25",
};
...
const AvatarStyles = Webpack.getByKeys(
  "moreUsers",
  "emptyUser",
  "avatarContainer",
  "clickableAvatar",
);
const Clickable = Webpack.getByStrings(
  "this.context?this.renderNonInteractive():",
  {
    searchExports: true,
  },
);
const RelationshipStore = Webpack.getStore("RelationshipStore");
const UserProfileActions = Webpack.getByKeys(
  "openUserProfileModal",
  "closeUserProfileModal",
);
const UserStore = Webpack.getStore("UserStore");
const UserSummaryItem = Webpack.getByStrings(
  "defaultRenderUser",
...
function SpectatorsTooltip({ spectatorIds, guildId, noTitle }) {
  if (!spectatorIds && !guildId) {
    const activeStream = useStateFromStores([ApplicationStreamingStore], () =>
        ...
        !!unknownSpectators &&
          React.createElement(
            ...
            React.createElement(
              ...
              null,
              "+",
              getLocalizedString(Strings.NUM_USERS, {
...
function SpectatorsPanel() {
  ...
  return React.createElement(
    ...
    spectatorIds.length
      ? React.createElement(UserSummaryItem, {
          ...
          renderMoreUsers: (label, count) => {
            ...
            return React.createElement(
              Tooltip,
              {
                text: React.createElement(SpectatorsTooltip, {
                  noTitle: true,
                  guildId: activeStream.guildId,
