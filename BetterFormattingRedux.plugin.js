...
var manifest = {
  info: {
    ...
    version: "2.3.15",
    description:
      "Enables different types of formatting in standard Discord chat.",
    github:
      "https://github.com/zerebos/BetterDiscordAddons/tree/master/Plugins/BetterFormattingRedux",
    github_raw:
      "https://raw.githubusercontent.com/zerebos/BetterDiscordAddons/master/Plugins/BetterFormattingRedux/BetterFormattingRedux.plugin.js",
  },
  changelog: [
    {
    ...
    },
    {
      ...
      settings: [
        ...
        },
        {
          ...
          id: "firstcapsWrapper",
          name: "First Caps",
          note: "The wrapper to capitalize the first letter.",
          value: "--",
        },
        {
          type: "text",
          id: "uppercaseWrapper",
          name: "Uppercase",
          note: "The wrapper to convert to uppercase.",
          value: ">>",
        },
        {
          type: "text",
          id: "lowercaseWrapper",
          name: "Lowercase",
          note: "The wrapper to convert to lowercase.",
          value: "<<",
        },
      ],
    },
...
var toolbar_default = {
  ...
  codeblock: {
    ...
    name: "Codeblock",
    displayName:
      "<span style='font-family:monospace;text-decoration: underline overline;'>|Codeblock|</span>",
...
var toolbar_default2 =
  '<div id="bfredux" class="bf-toolbar"><div class="bf-arrow"></div></div>';
...
var TextareaClasses = Webpack.getByKeys("channelTextArea", "textArea") ?? {
...
var BetterFormattingRedux = class extends Plugin {
  ...
  smallCapsList =
    " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`\u1D00\u0299\u1D04\u1D05\u1D07\uA730\u0262\u029C\u026A\u1D0A\u1D0B\u029F\u1D0D\u0274\u1D0F\u1D18\u01EB\u0280\uA731\u1D1B\u1D1C\u1D20\u1D21x\u028F\u1D22{|}";
  superscriptList =
    " !\"#$%&'\u207D\u207E*\u207A,\u207B./\u2070\xB9\xB2\xB3\u2074\u2075\u2076\u2077\u2078\u2079:;<\u207C>?@\u1D2C\u1D2E\u1D9C\u1D30\u1D31\u1DA0\u1D33\u1D34\u1D35\u1D36\u1D37\u1D38\u1D39\u1D3A\u1D3C\u1D3EQ\u1D3F\u02E2\u1D40\u1D41\u03BD\u1D42\u02E3\u02B8\u1DBB[\\]^_`\u1D43\u1D47\u1D9C\u1D48\u1D49\u1DA0\u1D4D\u02B0\u1DA6\u02B2\u1D4F\u02E1\u1D50\u207F\u1D52\u1D56\u146B\u02B3\u02E2\u1D57\u1D58\u1D5B\u02B7\u02E3\u02B8\u1DBB{|}";
  upsideDownList = ` \xA1"#$%\u2118,)(*+'-\u02D9/0\u0196\u218A\u0190\u07C8\u03DB9\u312586:;>=<\xBF@\u2200\u15FA\u0186\u15E1\u018E\u2132\uA4E8HI\u0550\uA4D8\uA4F6WNO\u0500\uA779\uA4E4S\uA4D5\uA4F5\u039BMX\u2144Z]\\[^\u203E,\u0250q\u0254p\u01DD\u025F\u1D77\u0265\u1D09\u027E\u029E\uA781\u026Fuodb\u0279s\u0287n\u028C\u028Dx\u028Ez}|{`;
  fullwidthList =
    "\u3000\uFF01\uFF02\uFF03\uFF04\uFF05\uFF06\uFF07\uFF08\uFF09\uFF0A\uFF0B\uFF0C\uFF0D\uFF0E\uFF0F\uFF10\uFF11\uFF12\uFF13\uFF14\uFF15\uFF16\uFF17\uFF18\uFF19\uFF1A\uFF1B\uFF1C\uFF1D\uFF1E\uFF1F\uFF20\uFF21\uFF22\uFF23\uFF24\uFF25\uFF26\uFF27\uFF28\uFF29\uFF2A\uFF2B\uFF2C\uFF2D\uFF2E\uFF2F\uFF30\uFF31\uFF32\uFF33\uFF34\uFF35\uFF36\uFF37\uFF38\uFF39\uFF3A\uFF3B\uFF3C\uFF3D\uFF3E\uFF3F\uFF40\uFF41\uFF42\uFF43\uFF44\uFF45\uFF46\uFF47\uFF48\uFF49\uFF4A\uFF4B\uFF4C\uFF4D\uFF4E\uFF4F\uFF50\uFF51\uFF52\uFF53\uFF54\uFF55\uFF56\uFF57\uFF58\uFF59\uFF5A\uFF5B\uFF5C\uFF5D";
  leetList =
    " !\"#$%&'()*+,-./0123456789:;<=>?@48CD3FG#IJK1MN0PQ\u042F57UVWXY2[\\]^_`48cd3fg#ijk1mn0pq\u042F57uvwxy2{|}";
  thiccList =
    "\u3000!\"#$%&'()*+,-./0123456789:;<=>?@\u5342\u4E43\u531A\u5200\u4E47\u4E0B\u53B6\u5344\u5DE5\u4E01\u957F\u4E5A\u4ECE\u3093\u53E3\u5C38\u353F\u5C3A\u4E02\u4E05\u51F5\u30EA\u5C71\u4E42\u4E2B\u4E59[\\]^_`\u5342\u4E43\u531A\u5200\u4E47\u4E0B\u53B6\u5344\u5DE5\u4E01\u957F\u4E5A\u4ECE\u3093\u53E3\u5C38\u353F\u5C3A\u4E02\u4E05\u51F5\u30EA\u5C71\u4E42\u4E2B\u4E59{|}";
  constructor(meta) {
    super(meta, config_default);
    this.customWrappers = this.manifest.config
      ?.find((g) => g.id === "wrappers")
      .settings.map((s) => s.id);
    this.buttonOrder = this.manifest.config
      ?.find((g) => g.id === "toolbar")
      .settings.map((s) => s.id);
  }
  async onStart() {
    ...
    if (!MessageActions)
      return Logger.error(
        this.meta.name,
        "Could not find MessageActions module!",
      );
    Patcher.before(
      this.meta.name,
      MessageActions,
  ...
  observer(e) {
    ...
    const textarea = elem.matches(`.${TextareaClasses.textArea}`)
      ? elem
      : elem.querySelector(`.${TextareaClasses.textArea}`);
  ...
  doFormat(text, wrapper, offset) {
    ...
    if (this.settings.chainFormats) {
      for (let w = 0; w < this.customWrappers.length; w++) {
        const newText = this.doFormat(
          returnText,
          this.settings[this.customWrappers[w]],
          begin + wrapper.length,
        );
    ...
    returnText = returnText.replace(
      new RegExp(
        `([^]{${begin}})${this.escape(wrapper)}([^]*)${this.escape(wrapper)}([^]{${len - end - 1}})`,
      ),
      (match, before, middle, after) => {
        ...
        if (
          wrapper == this.settings.upsidedownWrapper &&
          this.settings.reorderUpsidedown
        )
  ...
  format(string) {
    ...
    for (let i = 0; i < text.length; i++) {
      if (text[i] == "`") {
        ...
        for (let w = 0; w < this.customWrappers.length; w++) {
          if (
            !this.settings[this.customWrappers[w].replace("Wrapper", "Format")]
          )
            continue;
          const newText = this.doFormat(
            text,
  ...
  async wrapSelection(leftWrapper, rightWrapper) {
    ...
    if (slate.selection.anchor.offset <= slate.selection.focus.offset) {
      ...
      slate.apply({
        ...
        offset: slate.selection.anchor.offset,
      });
      slate.apply({
        type: "insert_text",
        text: rightWrapper,
        path: slate.selection.focus.path,
        offset: slate.selection.focus.offset,
      });
    } else {
  ...
  buildToolbar() {
    ...
    if (!this.settings.useIcons) {
      toolbar.addEventListener("mousemove", (e) => {
        ...
        const pos =
          e.pageX - (target.parentElement?.getBoundingClientRect()?.left ?? 0);
  ...
  setupToolbar() {
    document.querySelector(".bf-toolbar")?.remove();
    document
      .querySelectorAll(`.${TextareaClasses.textArea}`)
      .forEach((elem) => {
